...
> `CONSUMABLE`: The bearer can use this lesser artefact as a bonus action. If they do so, pick a visible friendly fighter within 12" of the bearer. You can remove D6 damage points allocated to that fighter.
